...
const translations = {
  it: {
    ...
    aboutTitle: "Chi sono",
    aboutHeadline: "Data Engineering, AI applicata e ricerca computazionale",
    aboutText1: "Lavoro come Data Engineer su flussi sanitari regolamentati, seguendo anomalie tra codice, configurazioni e database e verificando il comportamento dei processi fino ai test.",
    aboutText2: "Nei progetti personali porto lo stesso approccio verso Applied AI & Automation, prodotti software e ricerca indipendente, con Prof. Gecko, Diario di Bordo e Ringmin tra gli esempi più rappresentativi.",
    aboutFocusData: "Data Engineering",
    aboutFocusAI: "Applied AI & Automation",
    aboutFocusResearch: "Algorithms & Computational Research",
  ...
  en: {
    ...
    aboutTitle: "About",
    aboutHeadline: "Data Engineering, applied AI and computational research",
    aboutText1: "I work as a Data Engineer on regulated healthcare data flows, tracing anomalies across code, configurations and databases and validating process behaviour through testing.",
    aboutText2: "I bring the same approach to personal work across Applied AI & Automation, software products and independent research, with Prof. Gecko, Diario di Bordo and Ringmin among the most representative examples.",
    aboutFocusData: "Data Engineering",
    aboutFocusAI: "Applied AI & Automation",
    aboutFocusResearch: "Algorithms & Computational Research",
